...
const Contact = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen text-custom-gray flex flex-col py-24 sm:py-64 md:py-24 overflow-hidden"
    >
      ...
      <div className="md:absolute md:bottom-0 md:left-0 md:right-0 px-5 sm:px-6 md:px-[100px] py-16 sm:py-20 md:pb-64 flex items-center justify-start overflow-hidden">
        <h1
          ref={textRef}
          className="md:whitespace-nowrap text-6xl lg:text-[150px] leading-normal md:leading-[100px] w-full text-left"
        >
